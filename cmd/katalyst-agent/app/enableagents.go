...
import (
	...
	_ "github.com/kubewharf/katalyst-core/pkg/agent/qrm-plugins/power"
...
func init() {
	...
	agentInitializers.Store(qrm.QRMPluginNamePower, AgentStarter{Init: qrm.InitQRMPowerPlugins})
}
