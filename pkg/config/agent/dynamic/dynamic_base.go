...
import (
	...
	"github.com/kubewharf/katalyst-core/pkg/config/agent/dynamic/poweraware"
...
type Configuration struct {
	...
	*poweraware.PowerAwareConfiguration
}
...
func NewConfiguration() *Configuration {
	return &Configuration{
		...
		PowerAwareConfiguration:                  poweraware.NewPowerAwareConfiguration(),
	}
}
...
func (c *Configuration) ApplyConfiguration(conf *crd.DynamicConfigCRD) {
	...
	c.PowerAwareConfiguration.ApplyConfiguration(conf)
}
