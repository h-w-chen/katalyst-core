...
import (
	...
	"github.com/kubewharf/katalyst-core/pkg/metaserver/agent/metric/provisioner/mbm"
...
func init() {
	...
	RegisterProvisioners(metaserver.MetricProvisionerMemoryBandwidth, mbm.NewMBMetricsProvisioner)
}
