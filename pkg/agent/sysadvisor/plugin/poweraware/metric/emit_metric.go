...
func EmitPowerAdvisorHealthy(emitter metrics.MetricEmitter, statuses map[string]string) {
	_ = emitter.StoreInt64(metricPowerAdvisorHealthy, 1, metrics.MetricTypeNameRaw,
