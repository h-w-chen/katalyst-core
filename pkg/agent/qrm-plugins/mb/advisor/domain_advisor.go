...
func (d *domainAdvisor) adjust(_ context.Context,
	...
	for group := range groupedSettings {
		...
		general.InfofV(6, "[mbm] [advisor] 000 adjuster: group=%q, value=%v, currents=%v",
			group, values, currents)
		...
		general.InfofV(6, "[mbm] [advisor] 111 adjuster: group=%q, value=%v, currents=%v, result=%v",
