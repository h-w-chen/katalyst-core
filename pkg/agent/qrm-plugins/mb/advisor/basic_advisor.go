...
// basicAdvisor is an advisor which can only work with resctrl groups of distinct priorities;
// due to this limitation, it should not be used directly.
type basicAdvisor struct {
...
func (a *basicAdvisor) GetPlan(ctx context.Context, domainsMon *monitor.DomainStats) (*plan.MBPlan, error) {
...
func (a *basicAdvisor) getNoThrottleMB() int {
	if a.ccdMaxMB > 0 {
		return a.ccdMaxMB
	}
...
func (a *basicAdvisor) adjust(_ context.Context,
...
func (a *basicAdvisor) getIncomingDomainQuotas(_ context.Context, domIncomingInfo map[int]*resource.MBGroupIncomingStat,
) resource.DomQuotas {
...
func (a *basicAdvisor) calcIncomingDomainStats(ctx context.Context, mon *monitor.DomainStats,
...
func (a *basicAdvisor) calcIncomingStat(domID int, incomingStats monitor.GroupMBStats) (*resource.MBGroupIncomingStat, error) {
...
func (a *basicAdvisor) getEffectiveCapacity(domID int, domIncomingStats monitor.GroupMBStats) (int, error) {
...
func (a *basicAdvisor) deriveOutgoingTargets(_ context.Context,
...
func (a *basicAdvisor) distributeToCCDs(_ context.Context,
...
func (a *basicAdvisor) domainDistributeGroup(domID int, group string,
...
func newBasicAdvisor(emitter metrics.MetricEmitter, domains domain.Domains, ccdMinMB, ccdMaxMB int, defaultDomainCapacity int,
